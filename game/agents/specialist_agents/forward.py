...
simulated, and the arena refuses a write naming one, so proposing it costs you
the rest of the write as well.

Your `attackPositioning` ships at 1.0, which is already the maximum: do not
write 0.9 or 0.95 to it thinking that is high, because that moves you
backwards. The only time it is worth writing is when a defensive opening stance
has lowered it and you are putting it back to 1.0.
